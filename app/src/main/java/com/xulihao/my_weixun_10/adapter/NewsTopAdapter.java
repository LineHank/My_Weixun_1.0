 ...
 */
public class NewsTopAdapter extends RecyclerView.Adapter<NewsTopAdapter.MyViewHolder> {
    private List<News_Juhe_Top_Bean.ResultBean.DataBean> mData;
    private LayoutInflater inflater;
    private Context context;
    private NewsTopAdapter.OnItemClickListener mOnItemClickListener;

    public interface  OnItemClickListener{
        void onClick(int position);
        void onLongClick(int position);
    }
    public void setOnItemClickListener(NewsTopAdapter.OnItemClickListener onItemClickListener) {
        mOnItemClickListener = onItemClickListener;
    }

    public NewsTopAdapter(List<News_Juhe_Top_Bean.ResultBean.DataBean> mData, Context context) {
        this.mData = mData;
